Pod::Spec.new do |s|
  ...
  s.version          = '1.0.9'   # bump this with every release
  ...
  s.source           = {
    :http => "https://github.com/seinetime/seinetime-universal-sdk-ios/raw/main/SeinetimeUniversalSDK/1.0.9/SeinetimeUniversalSDK.xcframework.zip"
  }
