Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'   # bump this with every release
  ...
  s.source           = {
    :http => "https://github.com/seinetime/seinetime-universal-sdk-ios/raw/main/SeinetimeUniversalSDK/1.0.0/SeinetimeUniversalSDK.xcframework.zip"
  }
